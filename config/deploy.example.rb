...
#
# FPA is freely distributable under the terms of MIT license.
...
# OLD: 'git://github.com/fpavanza/fpavanza.git'
# GIT: https://github.com/capizod/fpavanza
# *** https://github.com/capizod/fpavanza.git

set :application,     'fpavanza'
set :repository,      'git://github.com/capizod/fpavanza.git'
set :branch,          'master'
set :scm,             :git
set :deploy_to,       ''
set :user,            ''
