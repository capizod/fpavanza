...
ActiveRecord::Schema.define(:version => 20130806172353) do
  ...
  add_index "account_contacts", ["account_id"], :name => "fk_account_contacts"
  add_index "account_contacts", ["contact_id"], :name => "fk_account_contacts_cacts"
  ...
  add_index "account_opportunities", ["account_id"], :name => "fk_account_opportunies_acc"
  add_index "account_opportunities", ["opportunity_id"], :name => "fk_account_opportunities_opp"
  ...
  add_index "account_products", ["account_id"], :name => "fk_account_acc_product"
  add_index "account_products", ["product_id"], :name => "fk_product_acc_product"
  ...
  add_index "accounts", ["account_type_id"], :name => "fk_acc_account_type"
  add_index "accounts", ["assigned_to"], :name => "index_accounts_on_assigned_to"
  add_index "accounts", ["company_id"], :name => "fk_acc_companies"
  ...
  add_index "avatars", ["user_id"], :name => "fk_avatar_users"
  ...
  add_index "bank_accounts", ["account_id"], :name => "fk_bank_accounts_acc"
  add_index "bank_accounts", ["bank_id"], :name => "fk_bank_accounts_opp"
  ...
  add_index "branches", ["bank_id"], :name => "fk_branches_bank"
  ...
  create_table "capacities", :force => true do |t|
    t.integer  "capacity_emploee_id",                                                                   :null => false
    t.integer  "capacity_tc_id",                                                                        :null => false
    t.integer  "region_id",                                                                             :null => false
    t.decimal  "monto_mex",                        :precision => 16, :scale => 2,                       :null => false
    t.integer  "city_id",                                                                               :null => false
    t.date     "capacity_add_date"
    t.integer  "capacity_te_id",                                                                        :null => false
    t.datetime "created_at",                                                                            :null => false
    t.datetime "updated_at",                                                                            :null => false
    t.string   "access",              :limit => 8,                                :default => "Public"
    t.integer  "user_id"
  ...
  add_index "capacities", ["capacity_tc_id"], :name => "fk_cap_cap_tc"
  add_index "capacities", ["capacity_te_id"], :name => "fk_cap_cap_te"
  add_index "capacities", ["city_id"], :name => "fk_cap_cities"
  add_index "capacities", ["region_id"], :name => "fk_cap_region"

  create_table "capacity_tcs", :force => true do |t|
    t.string   "name",       :null => false
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
  end

  create_table "capacity_tes", :force => true do |t|
    t.datetime "created_at", :null => false
    t.datetime "updated_at", :null => false
    t.string   "name",       :null => false
  end
  ...
  add_index "comments", ["user_id"], :name => "fk_comment_users"
  ...
  add_index "contact_opportunities", ["contact_id"], :name => "fk_contact_opportunities_cacts"
  add_index "contact_opportunities", ["opportunity_id"], :name => "fk_contact_opportunities_opp"
  ...
  add_index "contacts", ["lead_id"], :name => "fk_contacts_lead"
  ...
  add_index "emails", ["user_id"], :name => "fk_email_users"
  ...
  add_index "field_groups", ["tag_id"], :name => "fk_contacts_lead_tag"
  ...
  add_index "leads", ["campaign_id"], :name => "fk_campaign_lead"
  ...
  add_index "opportunities", ["campaign_id"], :name => "fk_campaign_opp"
  ...
  add_index "product_types", ["product_category_id"], :name => "fk_products_category_ptype"
  ...
  create_table "products", :force => true do |t|
    ...
    t.decimal  "monto_mex",                     :precision => 16, :scale => 2, :default => 0.0
    t.integer  "product_state_id"
  end

  add_index "products", ["product_state_id"], :name => "fk_products_product_state"
  add_index "products", ["provider_id"], :name => "fk_products_provider"
  add_index "products", ["provider_type_id"], :name => "fk_products_provider_typ"
  ...
  create_table "providers", :force => true do |t|
    ...
    t.datetime "updated_at",                     :null => false
    t.string   "account_number"
    t.integer  "provider_key",                   :null => false
  end

  add_index "providers", ["provider_type_id"], :name => "fk_providers_provider_type"
